            ...
            createPicker () {
                if (this.lookup.length) {
                    ...
                    this.lookup.forEach((yearLabel, yearIndex) => {
                        ...
                        move.addEventListener("click", () => { this.moveTo(); });
                        copy.addEventListener("click", () => { this.copyFrom(); });
        ...
        function createReportStyle () {
            ...
            style.innerText += `
                ...
                * {
                ...
                body {
                    background-image: url(https://imgur.com/MxW83Qb.jpg);
                ...
                header > .background {
                    ...
                    justify-content: center;
                    align-items: center;
                    background-image: linear-gradient(45deg, #100a12 0%, #1d1420 20%, #3a2941 40%, #1d1420 60%, #160e17 80%, #100a12 100%);
                    width: 100%;
                    height: 65px;
                    position: absolute;
                    overflow: hidden;
                ...
                #picker .buttons .year .month button {
                    display: flex;
                    justify-content: center;
                    align-items: center;
                }
                ...
                footer .pattern {
                    width: 100%;
                    height: 100%;
                    background-image: url(https://imgur.com/YnA0kqn.jpg);
                    background-repeat: no-repeat;
                    background-size: cover;
