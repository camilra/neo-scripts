...

    {
        ...
        class Report {
            ...
            pickerActive (yearIndex, monthIndex) {
                ...
                years[yearIndex].querySelectorAll(".pick")[monthIndex].classList.add("active");
            ...
            style.innerText += `
                ...
                * {
                ...
                html :root, html body {
                    ...
                    --body-font-family: "MuseoSansRounded700", "Arial Bold", sans-serif;
                    --body-title-font-family: "Cafeteria", "Arial Bold", sans-serif;
                }

                html[data-theme=light] {
                    background-color: #f1a1a4;
                    background-image: url(https://i.imgur.com/6xxj63I.jpg);
                }

                html[data-theme=light] :root, html[data-theme=light] body {
                    --body-color: #3C0309;
                    --body-text-color: #2c0000;
                    ...
                    --header-picker-background-image: linear-gradient(0deg, #eec8ca 0%, #fde9d0 100%);
                    --header-picker-button-border: #ee9fa4;
                    --header-picker-button-outline: #ab6de8;
                ...
                html[data-theme=dark] {
                    ...
                    background-image: url(https://i.imgur.com/bWAVtvj.jpg);
                }
                ...
                html[data-theme=dark] :root, html[data-theme=dark] body {
                    ...
                    --header-picker-button-border: #705A83;
                    --header-picker-button-outline: #fdcc01;
                    --header-picker-action-button-background-image: url(https://gist.githubusercontent.com/Camilra/32969190af24447eae8d29ebfe6418fc/raw/3045a6f9eb2ffe99eca95c2d09ab42bafab5525a/button-pattern-dark.svg);
                    --header-picker-action-button-image: url(https://gist.githubusercontent.com/Camilra/d3634393599cbfd1cd2a4129ad1c5658/raw/7024ad848808a5daa7ef0c8d1ff292fb2c01914b/button-dark.svg);
                ...
                header nav .picker .tag.active + .dropdown #picker .buttons fieldset .year.active {
                    visibility: visible;
                    opacity: 1;
                }
                ...
                #picker .buttons fieldset .year .pick {
                    display: flex;
                    justify-content: center;
                    align-items: center;
                }

                #picker .buttons select, #picker .buttons fieldset .year .pick {
                    font-family: var(--body-font-family);
                    background-color: var(--white-80);
                    color: var(--body-text-color);
                    padding: 7.5px;
                ...
                #picker .buttons select:focus-visible, #picker .buttons fieldset .year .pick:focus-visible {
                    outline-offset: 2px;
                }

                #picker .buttons select.active, #picker .buttons fieldset .year .pick.active {
                    background-color: var(--header-picker-button-border);
                    color: #fff;
                }
                ...
                #picker .action button {
                    ...
                    border-radius: 3px;
                    outline: solid 1px var(--header-picker-button-border);
                }

                #picker .action button:hover div, #picker .action button:focus-visible div {
                    transform: scale(1.1);
                }
        ...
        if (window.location.href.toLowerCase().includes("/~camilra")) {
            // KQ.forEach((record, index) => {
            //     switch (true) {
            //         case index >= 2000:
            //             record.nst.year = 2030;
            //             break;
            //         case index >= 1750:
            //             record.nst.year = 2029;
            //             break;
            //         case index >= 1500:
            //             record.nst.year = 2028;
            //             break;
            //         case index >= 1250:
            //             record.nst.year = 2027;
            //             break;
            //         case index >= 1000:
            //             record.nst.year = 2026;
            //             break;
            //         case index >= 750:
            //             record.nst.year = 2025;
            //             break;
            //         case index >= 500:
            //             record.nst.year = 2024;
            //             break;
            //         case index >= 250:
            //             record.nst.year = 2023;
            //             break;
            //     };
            // });
